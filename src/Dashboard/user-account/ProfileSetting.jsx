        ...
        <div className="flex gap-12 w-full lg:w-3/4">
          <div className="flex mb-10">
            ...
            <select
              ...
              className=" ml-2 text-center  text-[var(--my-color)] bg-primaryColor"          >
          ...
          <div className="flex mb-10">
            ...
            <select
              name="gender" id="gender" value={formData.gender} onChange={handleInputChange} className="w-3/4 text-center text-[var(--my-color)] bg-primaryColor">
