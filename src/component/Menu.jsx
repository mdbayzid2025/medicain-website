    ...
    <div className='h-[100svh] relative'>
      ...
      <ul className="gap-6  flex flex-col justify-center  mx-5 ml-4 pt-12">
        {navLinks && navLinks.map((link, index) =>
          <NavLink to={link.path} onClick={() => setOpen(!open)} className={navClass => navClass.isActive ? "text-primaryColor text-lg  font-[600] text-center  flex items-center gap-12 py-3 px-2 bg-blue-200"
      ...
      {user && role ?
        <>
          ...
          <NavLink
            ...
            to={`${role === "patient" ? "/users" : "/doctors"}/profile/${user._id}`} className={navClass => navClass.isActive ? "text-primaryColor text-lg  font-[600] text-center  flex items-center gap-2 py-3 px-2 bg-blue-200 mx-5"
