            ...
            <div className="container">
                <div className="flex justify-between items-center">
                   ...
                   Sign Up
                                    ...
                                    <button className="bg-primaryColor text-white font-semibolds flex justify-center items-center rounded-lg cursor-pointer py-2 px-6  min-w-[120px] h-[40px] mt-0">
                                        Sign Up
                                    </button>
                                </Link>
                            </div>}
